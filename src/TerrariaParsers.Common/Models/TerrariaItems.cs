...
public enum TerrariaItems : short
{
    ...
    DeadCellsMushroomBoiSummonItem = 5456,

    DeadCellsBeheadedHead = 5457,

    DeadCellsBeheadedBody = 5458,

    DeadCellsBeheadedLegs = 5459,

    DeadCellsBarrelLauncher = 5460,

    DeadCellsKillingDeck = 5461,

    DeadCellsFlint = 5462,

    DeadCellsBarnacleSummonItem = 5463,

    MiteyTitey = 5464,

    DeadCellsRamRune = 5465,

    DeadCellsSwarmGrenade = 5466,

    DemonAltarReplica = 5467,

    CrimsonAltarReplica = 5468,

    ShadowOrbReplica = 5469,

    CrimsonHeartReplica = 5470,

    CobwebReplica = 5471,

    DeadCellsDisplayJar = 5472,
    ...
    ConstellationWhip = 5479,

    MoonLordWhip = 5480,

    PortableKiln = 5481,

    DeadCellsPotionStation = 5482,

    QueenOfBees = 5483,

    PlayerVoiceCowbellItem = 5484,

    PlayerVoiceChickenFeetItem = 5485,

    TheSeaOfSilence = 5486,

    HeroesFromAnotherWorld = 5487,
    ...
    WinterAtVaringskollen = 5491,

    MagicShimmerDropper = 5492,

    ShimmerFallBlock = 5493,

    ShimmerFallWall = 5494,

    ShimmerGun = 5495,

    LifeFruitHealingPotion = 5496,

    PinkBanner = 5497,

    WhiteBanner = 5498,

    PlayerVoiceFrogItem = 5499,

    PlayerVoiceGoatItem = 5500,

    PlayerVoiceRetroItem = 5501,

    PlayerVoiceCatItem = 5502,

    PlayerVoiceDogItem = 5503,

    PlayerVoiceTurkeyItem = 5504,

    PlayerVoiceGoblinItem = 5505,

    PlayerVoiceCrowItem = 5506,

    PlayerVoiceBalloonItem = 5507,

    PlayerVoiceUndeadItem = 5508,

    PlayerVoiceVampireItem = 5509,

    VelociraptorMountItem = 5510,
    ...
    AxeFairyPetItem = 5517,

    SuperFertilizer = 5518,
    ...
    BannerOfTheBeast = 5529,

    StickmanVsTerrTerr = 5530,
    ...
    LivingWoodWallUnsafe = 5545,

    DirtWallUnsafe = 5546,

    StrungCounterweight = 5547,

    AetheriumBathtub = 5548,

    AetheriumBed = 5549,

    AetheriumBookcase = 5550,

    AetheriumDresser = 5551,

    AetheriumCandelabra = 5552,

    AetheriumCandle = 5553,

    AetheriumChair = 5554,

    AetheriumChandelier = 5555,
    ...
    AetheriumLantern = 5560,

    AetheriumPiano = 5561,

    AetheriumPlatform = 5562,
    ...
    AetheriumWorkbench = 5566,

    Fake_AetheriumChest = 5567,

    AetheriumToilet = 5568,
    ...
    MusicBoxKingSlime = 5578,

    MusicBoxQueenBeeAlt = 5579,

    MusicBoxLunaticCultist = 5580,

    MusicBoxSkeletronPrime = 5581,

    MusicBoxDestroyer = 5582,

    ChickenBonesHead = 5583,

    ChickenBonesBody = 5584,

    ChickenBonesLegs = 5585,

    ChickenBonesWings = 5586,

    ChickenBonesRobe = 5587,

    UpgradedMiningHead = 5588,

    UpgradedMiningBody = 5589,

    UpgradedMiningLegs = 5590,

    UpgradedFishingHead = 5591,

    UpgradedFishingBody = 5592,

    UpgradedFishingLegs = 5593,

    SuperBomb = 5594,

    SuperStickyBomb = 5595,
    ...
    RollerSkatesBlueMountItem = 5600,

    FallenStarBathtub = 5601,

    FallenStarBed = 5602,

    FallenStarBookcase = 5603,

    FallenStarDresser = 5604,

    FallenStarCandelabra = 5605,

    FallenStarCandle = 5606,

    FallenStarChair = 5607,

    FallenStarChandelier = 5608,

    FallenStarChest = 5609,

    FallenStarClock = 5610,

    FallenStarDoor = 5611,

    FallenStarLamp = 5612,

    FallenStarLantern = 5613,

    FallenStarPiano = 5614,

    FallenStarPlatform = 5615,

    FallenStarSink = 5616,

    FallenStarSofa = 5617,

    FallenStarTable = 5618,

    FallenStarWorkbench = 5619,

    Fake_FallenStarChest = 5620,

    FallenStarToilet = 5621,

    FallenStarBlock = 5622,
    ...
    ChippysHeadband = 5628,

    AcornSlingshot = 5629,

    PaintingRPlace2023 = 5630,

    PaintingBouldChoices = 5631,

    PaintingDarkForebodings = 5632,

    PaintingGermanZenith = 5633,

    PaintingItsScragglinTime = 5634,

    PaintingKaguya = 5635,

    PaintingGermanBeer = 5636,

    MusicBoxEaterOfWorlds = 5637,

    MusicBoxTorchGod = 5638,

    MusicBoxTorchGodAlt = 5639,

    RollerSkatesGreenMountItem = 5640,

    RollerSkatesClassicMountItem = 5641,

    RollerSkatesPartyMountItem = 5642,

    RainbowGlowstick = 5643,
    ...
    GreenSwimshorts = 5649,

    GraySwimshorts = 5650,

    OrcaBanner = 5651,

    TeleportationPylonUnderworld = 5652,

    TeleportationPylonShimmer = 5653,

    RainbowBoulderPet = 5654,
    ...
    HeroicisWingsInactive = 5661,

    EnchantedPixieDust = 5662,

    PalworldMinionCattiva = 5663,

    PalworldMinionFoxsparks = 5664,

    PalworldPetChillet = 5665,

    PalworldPetChilletIgnis = 5666,

    PalworldDigtoise = 5667,

    SoundGun = 5668,

    TrueCopperShortsword = 5669,

    RainbowPhaseblade = 5670,

    RainbowPhasesaber = 5671,

    LibrarianSkeletonBanner = 5672,

    WaterBoltMimicBanner = 5673,

    TeamBlockRedVariant = 5674,

    TeamBlockGreenVariant = 5675,

    TeamBlockBlueVariant = 5676,

    TeamBlockYellowVariant = 5677,

    TeamBlockPinkVariant = 5678,

    TeamBlockWhiteVariant = 5679,
    ...
    KazzymodusChestpiece = 5684,

    KazzymodusLeggings = 5685,

    KazzymodusWings = 5686,
    ...
    FeywoodBookcase = 5691,

    FeywoodDresser = 5692,

    FeywoodCandelabra = 5693,

    FeywoodCandle = 5694,

    FeywoodChair = 5695,

    FeywoodChandelier = 5696,
    ...
    FeywoodWorkbench = 5707,

    Fake_FeywoodChest = 5708,
    ...
    HallowedBathtub = 5712,

    HallowedBed = 5713,

    HallowedBookcase = 5714,

    HallowedDresser = 5715,

    HallowedCandelabra = 5716,

    HallowedCandle = 5717,

    HallowedChair = 5718,

    HallowedChandelier = 5719,

    HallowedFurnitureChest = 5720,
    ...
    HallowedLantern = 5724,

    HallowedPiano = 5725,

    HallowedPlatform = 5726,
    ...
    HallowedWorkbench = 5730,

    Fake_HallowedFurnitureChest = 5731,

    HallowedToilet = 5732,

    HallowedBrick = 5733,

    HallowedBrickWall = 5734,

    PalworldPalMetalArmorBody = 5735,

    PalworldPalMetalArmorLegs = 5736,

    ChippysWingsInactive = 5737,

    RemoteControlCar = 5738,
    ...
    GothicCandelabra = 5742,

    GothicCandle = 5743,

    GothicChandelier = 5744,
    ...
    Fake_GothicChest = 5754,

    GothicToilet = 5755,

    DemoniteBathtub = 5756,

    DemoniteBed = 5757,

    DemoniteBookcase = 5758,

    DemoniteCandelabra = 5759,

    DemoniteCandle = 5760,

    DemoniteChair = 5761,

    DemoniteChandelier = 5762,
    ...
    DemoniteDresser = 5766,

    DemoniteLamp = 5767,

    DemoniteLantern = 5768,

    DemonitePiano = 5769,

    DemonitePlatform = 5770,
    ...
    DemoniteWorkbench = 5775,

    Fake_DemoniteChest = 5776,

    CrimtaneBathtub = 5777,

    CrimtaneBed = 5778,

    CrimtaneBookcase = 5779,

    CrimtaneCandelabra = 5780,

    CrimtaneCandle = 5781,

    CrimtaneChair = 5782,

    CrimtaneChandelier = 5783,
    ...
    CrimtaneDresser = 5787,

    CrimtaneLamp = 5788,

    CrimtaneLantern = 5789,

    CrimtanePiano = 5790,

    CrimtanePlatform = 5791,
    ...
    CrimtaneWorkbench = 5796,

    Fake_CrimtaneChest = 5797,
    ...
    FlinxFurBathtub = 5819,

    FlinxFurBed = 5820,

    FlinxFurBookcase = 5821,

    FlinxFurCandelabra = 5822,

    FlinxFurCandle = 5823,

    FlinxFurChair = 5824,

    FlinxFurChandelier = 5825,
    ...
    FlinxFurDresser = 5829,

    FlinxFurLamp = 5830,

    FlinxFurLantern = 5831,

    FlinxFurPiano = 5832,

    FlinxFurPlatform = 5833,
    ...
    FlinxFurWorkbench = 5838,

    Fake_FlinxFurChest = 5839,
    ...
    EasterCandelabra = 5861,

    EasterCandle = 5862,

    EasterChair = 5863,

    EasterChandelier = 5864,
    ...
    EasterWorkbench = 5877,

    Fake_EasterChest = 5878,
    ...
    StoneCandelabra = 5882,

    StoneCandle = 5883,

    StoneChair = 5884,

    StoneChandelier = 5885,
    ...
    Fake_StoneChest = 5897,

    JellyfishBathtub = 5898,

    JellyfishBed = 5899,

    JellyfishBookcase = 5900,

    JellyfishCandelabra = 5901,

    JellyfishCandle = 5902,

    JellyfishChair = 5903,

    JellyfishChandelier = 5904,
    ...
    JellyfishDresser = 5908,

    JellyfishLamp = 5909,

    JellyfishLantern = 5910,

    JellyfishPiano = 5911,

    JellyfishPlatform = 5912,
    ...
    JellyfishToilet = 5916,

    JellyfishWorkbench = 5917,

    Fake_JellyfishChest = 5918,

    PineTreeBlockWall = 5919,

    EasterBlock = 5920,

    EasterBlockWall = 5921,

    GothicBrick = 5922,

    GothicBrickWall = 5923,

    FlinxFurBlock = 5924,

    FlinxFurBlockWall = 5925,

    JellyfishBlock = 5926,

    JellyfishBlockWall = 5927,

    ToyBreakerBlock = 5928,

    PaintingRemix = 5929,

    PineWoodBlock = 5930,

    PineWoodBlockWall = 5931,
    ...
    HarpyCandelabra = 5935,

    HarpyCandle = 5936,

    HarpyChair = 5937,

    HarpyChandelier = 5938,
    ...
    CloudCandelabra = 5958,

    CloudCandle = 5959,

    CloudChair = 5960,

    CloudChandelier = 5961,
    ...
    Fake_CloudChest = 5974,

    MoonplateBathtub = 5975,

    MoonplateBed = 5976,

    MoonplateBookcase = 5977,

    MoonplateCandelabra = 5978,

    MoonplateCandle = 5979,

    MoonplateChair = 5980,

    MoonplateChandelier = 5981,
    ...
    MoonplateDresser = 5985,

    MoonplateLamp = 5986,

    MoonplateLantern = 5987,

    MoonplatePiano = 5988,

    MoonplatePlatform = 5989,
    ...
    MoonplateToilet = 5993,

    MoonplateWorkbench = 5994,

    Fake_MoonplateChest = 5995,

    MoonplateBlock = 5996,

    MoonplateBlockWall = 5997,

    LibrarianBathtub = 5998,

    LibrarianBed = 5999,

    LibrarianBookcase = 6000,

    LibrarianCandelabra = 6001,

    LibrarianCandle = 6002,

    LibrarianChair = 6003,

    LibrarianChandelier = 6004,
    ...
    LibrarianDresser = 6008,

    LibrarianLamp = 6009,

    LibrarianLantern = 6010,

    LibrarianPiano = 6011,

    LibrarianPlatform = 6012,
    ...
    LibrarianToilet = 6016,

    LibrarianWorkbench = 6017,

    Fake_LibrarianChest = 6018,

    LibrarianBlock = 6019,

    LibrarianBlockWall = 6020,
    ...
    SpikeCandelabra = 6024,

    SpikeCandle = 6025,

    SpikeChair = 6026,

    SpikeChandelier = 6027,
    ...
    OfficeCandelabra = 6047,

    OfficeCandle = 6048,

    OfficeChair = 6049,

    OfficeChandelier = 6050,
    ...
    OfficeWorkbench = 6063,

    Fake_OfficeChest = 6064,

    OfficeBlock = 6065,

    OfficeBlockWall = 6066,

    ForbiddenBathtub = 6067,

    ForbiddenBed = 6068,

    ForbiddenBookcase = 6069,

    ForbiddenCandelabra = 6070,

    ForbiddenCandle = 6071,

    ForbiddenChair = 6072,

    ForbiddenChandelier = 6073,
    ...
    ForbiddenDresser = 6077,

    ForbiddenLamp = 6078,

    ForbiddenLantern = 6079,

    ForbiddenPiano = 6080,

    ForbiddenPlatform = 6081,
    ...
    ForbiddenToilet = 6085,

    ForbiddenWorkbench = 6086,

    Fake_ForbiddenChest = 6087,

    ForbiddenBlock = 6088,

    ForbiddenBlockWall = 6089,
    ...
    WaterCandelabra = 6093,

    WaterFurnitureCandle = 6094,

    WaterChair = 6095,

    WaterChandelier = 6096,
    ...
    BoulderBookcase = 6113,

    BoulderCandelabra = 6114,

    BoulderCandle = 6115,

    BoulderChair = 6116,

    BoulderChandelier = 6117,
    ...
    BoulderWorkbench = 6130,

    Fake_BoulderChest = 6131,

    BoulderBlock = 6132,

    BoulderBlockWall = 6133,

    DamagingSpikeBlock = 6134,

    DemonAltarIcon = 6135,

    CrimsonAltarIcon = 6136,
    ...
    PalworldChilletEgg = 6142,

    FoxparksTagEffect = 6143,

    MusicBoxSkeletron = 6144,
}
