...
public static class TerrariaLegacyItemConverter
{
    private static Dictionary<string, short> _legacyItemLookup = new()
    {
        { "Iron Pickaxe", 1 },
        { "Dirt Block", 2 },
        { "Stone Block", 3 },
    ...
    public static TerrariaItems FromLegacyName(string name, int releaseVersion)
    {
        if (releaseVersion <= 4)
        {
            switch (name)
        ...
        if (releaseVersion <= 13 && name == "Jungle Rose")
        {
            name = "Jungle Spores";
        }
        ...
        if (releaseVersion <= 41 && name == "Iron Chain")
        {
            name = "Chain";
        }
        if (releaseVersion <= 44 && name == "Orb of Light")
        {
            name = "Shadow Orb";
        }
        if (releaseVersion <= 46)
        {
            if (name == "Black Dye")
            {
                name = "Black Thread";
        ...
        {
            return (TerrariaItems)value;
        }
        return TerrariaItems.None;
    }
}
